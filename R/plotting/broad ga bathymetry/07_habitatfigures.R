...
png(filename = "plots/site_spatial_layers.png", res = 300, units = "in",
    width = 12, height = 15)

pd + pt + pr + pdt + p4 + plot_spacer() + 
  theme(text = element_text(size = 8)) + plot_layout(ncol = 2)                  # This way aligns properly to the left
