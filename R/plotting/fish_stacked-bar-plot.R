...
bar.shallow.top.10<-ggplot(maxn.shallow.10, aes(x=reorder(scientific,maxn), y=maxn)) +   
  ...
  theme_collapse+
  theme.larger.text+
  annotation_raster(p.c, xmin=9.7,xmax=10.2,ymin=800, ymax=880)+
  annotation_raster(l.a, xmin=8.6,xmax=9.3,ymin=500, ymax=600)+
  annotation_raster(c.fv, xmin=7.65, xmax=8.45, ymin=400, ymax=570)+
  annotation_raster(h.spp, xmin=6.75,xmax=7.25,ymin=290, ymax=370)+
  annotation_raster(t.l, xmin=5.8,xmax=6.2,ymin=260, ymax=400)+
  annotation_raster(c.f, xmin=4.8,xmax=5.2,ymin=210, ymax=290)+
  annotation_raster(a.g, xmin=3.75,xmax=4.25,ymin=210, ymax=330)+
  annotation_raster(c.c, xmin=2.5,xmax=3.5,ymin=200, ymax=300)+
  annotation_raster(p.e, xmin=1.725,xmax=2.275,ymin=190, ymax=290)+
  annotation_raster(p.n, xmin=0.75,xmax=1.25,ymin=190, ymax=270)
bar.shallow.top.10
